...
//    {
//        private readonly string? firebaseServiceAccountBase64String = Environment.GetEnvironmentVariable("FIREBASE_SERVICE_ACCOUNT_BASE64");
...
//        {
//            if (firebaseServiceAccountBase64String==null)
//            {
//                throw new ArgumentNullException(nameof(firebaseServiceAccountBase64String), "environment variable firebaseServiceAccountBase64String is not found or recognized");
//            }
//            FirebaseServiceAccount? serviceAccount = JsonConvert.DeserializeObject<FirebaseServiceAccount>(firebaseServiceAccountBase64String!); 
//            string projectId = GetProjectId(file);
//            mFirebaseEndpoint = new Uri(string.Format(FCM_URI, serviceAccount.ProjectId));
